...
class ssh_util():
    def __init__(self):
        ...
        # self.ssh_error = None
        self.client = None
        self.host = "10.2.136.254"
        self.username = "aman_2110"
        self.password = "Aman@8055"
    ...
    def connect(self):
        ...
        try:
            ...
            self.client.connect(hostname=self.host, username=self.username, password=self.password, allow_agent=False,
                                look_for_keys=False)
